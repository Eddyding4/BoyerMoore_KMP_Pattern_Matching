    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 1; i < 3; i++) {
                ...
                pattern.testPattern("C:\\Users\\Eddy\\IdeaProjects\\CS 251 Project 5\\src\\testFiles\\pattern_test" + i);
            ...
            for (int i = 1; i < 3; i++) {
                ...
                pattern.testMatrix("C:\\Users\\Eddy\\IdeaProjects\\CS 251 Project 5\\src\\testFiles\\matrix_test" + i);
                System.out.println("Score: " + pattern.score + "\n");
                totalScore += pattern.score;
            }
